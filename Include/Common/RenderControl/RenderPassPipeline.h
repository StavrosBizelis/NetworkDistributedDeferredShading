...
namespace RenderControl
{
	...
	public:
		RenderPassPipeline(MaterialControl::IMaterialManager* a_materialManager);
		...
		MaterialControl::IMaterialManager* const GetMaterialManager() const;		///< valid as long as this RenderControl object is - DO NOT DELETE
	};
}