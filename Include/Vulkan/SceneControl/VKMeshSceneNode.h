...
namespace SceneControl
{
	...
	public:
		VKMeshSceneNode(SceneNode* a_parent, const std::shared_ptr<IMesh>& a_mesh, std::vector<VKMeshSceneNode*>& a_updateRegistry );
    ...
    virtual std::shared_ptr<VKShape> GetShape(){ return m_mesh;}
