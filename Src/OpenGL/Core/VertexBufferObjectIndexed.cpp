...
// Binds the buffers
void CVertexBufferObjectIndexed::Bind() const
{
...
void CVertexBufferObjectIndexed::AddVertexData(void* ptrVertexData, unsigned int uiVertexDataSize)
{
	m_vertexData.insert(m_vertexData.end(), (char*)ptrVertexData, (char*)ptrVertexData+uiVertexDataSize);
}


// Adds data to the VBO.  
void CVertexBufferObjectIndexed::AddIndexData(void* ptrIndexData, unsigned int uiIndexDataSize)
{
	m_indexData.insert(m_indexData.end(), (char*)ptrIndexData, (char*)ptrIndexData+uiIndexDataSize);
}
